...
import fit.bestteam.pubster.dl.entity.Manager;
 ...
 */
@Stateless
@Path("fit.bestteam.pubster.dl.entity.manager")
public class ManagerFacadeREST extends AbstractFacade<Manager> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Manager entity) {
        super.edit(entity);
    }
    ...
    public Manager find(@PathParam("id") Integer id) {
